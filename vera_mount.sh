...
# decrypting harddrive using key file (dropping privilieges for mounting)
...
sudo service smbd status 2>/dev/null && echo "[+] Samba service running" || sudo service smbd start
